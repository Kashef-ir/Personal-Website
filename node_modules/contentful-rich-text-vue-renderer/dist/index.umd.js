(function (global, factory) {
  ...
  var defaultInline = function defaultInline(type, node, key) {
    return h("span", {
      key: key,
      style: {
        margin: "0px 5px",
  ...
  var defaultMarkRenderers = (_defaultMarkRenderers = {}, _defineProperty(_defaultMarkRenderers, dist.MARKS.BOLD, function (children, key) {
    return h("strong", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.ITALIC, function (children, key) {
    return h("em", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.UNDERLINE, function (children, key) {
    return h("u", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.CODE, function (children, key) {
    return h("code", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.SUPERSCRIPT, function (children, key) {
    return h("sup", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.SUBSCRIPT, function (children, key) {
    return h("sub", {
      key: key
    }, children);
  }), _defineProperty(_defaultMarkRenderers, dist.MARKS.STRIKETHROUGH, function (children, key) {
    return h("s", {
      key: key
    }, children);
  }), _defaultMarkRenderers);
  var defaultNodeRenderers = (_defaultNodeRenderers = {}, _defineProperty(_defaultNodeRenderers, dist.BLOCKS.PARAGRAPH, function (node, key, next) {
    return h("p", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_1, function (node, key, next) {
    return h("h1", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_2, function (node, key, next) {
    return h("h2", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_3, function (node, key, next) {
    return h("h3", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_4, function (node, key, next) {
    return h("h4", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_5, function (node, key, next) {
    return h("h5", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HEADING_6, function (node, key, next) {
    return h("h6", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.EMBEDDED_ENTRY, function (node, key, next) {
    return h("div", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.UL_LIST, function (node, key, next) {
    return h("ul", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.OL_LIST, function (node, key, next) {
    return h("ol", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.LIST_ITEM, function (node, key, next) {
    return h("li", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.QUOTE, function (node, key, next) {
    return h("blockquote", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.TABLE, function (node, key, next) {
    return h("table", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.TABLE_ROW, function (node, key, next) {
    return h("tr", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.TABLE_CELL, function (node, key, next) {
    return h("td", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.TABLE_HEADER_CELL, function (node, key, next) {
    return h("th", {
      key: key
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, dist.BLOCKS.HR, function (_node, key) {
    return h("hr", {
      key: key
    });
  }), _defineProperty(_defaultNodeRenderers, dist.INLINES.ASSET_HYPERLINK, function (node, key) {
    return defaultInline(dist.INLINES.ASSET_HYPERLINK, node, key);
  }), _defineProperty(_defaultNodeRenderers, dist.INLINES.ENTRY_HYPERLINK, function (node, key) {
    return defaultInline(dist.INLINES.ENTRY_HYPERLINK, node, key);
  }), _defineProperty(_defaultNodeRenderers, dist.INLINES.EMBEDDED_ENTRY, function (node, key) {
    return defaultInline(dist.INLINES.EMBEDDED_ENTRY, node, key);
  }), _defineProperty(_defaultNodeRenderers, dist.INLINES.HYPERLINK, function (node, key, next) {
    return h("a", {
      key: key,
      href: node.data.uri
    }, next(node.content, key, next));
  }), _defineProperty(_defaultNodeRenderers, "text", function text(_ref, key, markRenderer) {
  ...
  var RichText = function RichText(_ref2) {
    var nodeRenderers = _ref2.nodeRenderers,
        markRenderers = _ref2.markRenderers,
    ...
    var renderer = {
      node: _objectSpread2(_objectSpread2({}, defaultNodeRenderers), nodeRenderers),
      mark: _objectSpread2(_objectSpread2({}, defaultMarkRenderers), markRenderers)
    };
